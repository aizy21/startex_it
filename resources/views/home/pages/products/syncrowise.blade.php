        ...
        <div class="container">
            <div class="row justify-content-center reveal">
                <div class="col-lg-8">
                    ...
                    <h1 class="display-3 mb-4">Syncrowise Platform</h1>
                    ...
                    <a class="btn btn-theme btn-lg px-5" href="index.html#contact">Start Free Trial</a>
                </div>
            </div>
            <div class="row justify-content-center mt-5 reveal" style="transition-delay: 0.2s;">
                <div class="col-lg-10">
                    <img class="img-fluid mockup-img" src="https://placehold.co/1200x600/13ce85/001b3d?text=Trakset+Dashboard+Interface" alt="Product UI">
                </div>
            </div>
        </div>
    </header>
